...
//		System.out.println(postParameters);
		...
		postParameters += "&searchCriteria.toPublicationDate=31-12-2015";
		...
		System.out.println(maxPag + " páginas.");
		//System.exit(0);
...
//		System.out.println("Procesando respuesta:");
		...
		for (int i = 1; (headerName = conn.getHeaderFieldKey(i)) != null; i++) {
			System.out.println("Cabecera: " + conn.getHeaderFieldKey(i));
		...
		System.out.println("La Cookie es: " + cookie);
